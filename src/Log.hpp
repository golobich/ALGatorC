...
namespace easyloggingpp {
    ...
    namespace internal {
        ...
        public:
            ...
            PATH_SLASH                    ("\\"),
#endif // _ELPP_OS_UNIX,
            DEFAULT_LOG_FILENAME          ("AlgatorC.log")
            {
...
#if _ELPP_OS_UNIX
#   if _ELPP_NDK
            setAll(ConfigurationType::Filename, "/data/local/tmp/AlgatorC.txt");
#   else
            setAll(ConfigurationType::Filename, "/tmp/logs/AlgatorC.log");
#   endif // _ELPP_NDK
#elif _ELPP_OS_WINDOWS
            setAll(ConfigurationType::Filename, "logs\\AlgatorC.log");
#endif // _ELPP_OS_UNIX
